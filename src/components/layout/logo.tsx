...
import logoMark from "../../../public/n8x-logo.jpg";

/**
 * Brand logo. Renders the `n8x-logo.jpg` mark (which already contains the
 ...
 * clips the JPG's square corners so they don't show on dark backgrounds.
 *
