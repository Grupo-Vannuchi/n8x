...
export function ServiceCard({ service }: { service: ServiceView }) {
  return (
    <Link
      ...
      className="group flex h-full flex-col gap-4 rounded-xl border border-border bg-card p-6 transition-[transform,box-shadow,border-color] duration-300 hover:-translate-y-1 hover:border-accent/40 hover:shadow-md focus-visible:shadow-md"
    >
